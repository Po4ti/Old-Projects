...
global.roomCaptionDef = "I Wanna Defeat The 4 Horsemen Of Hardcore Gaming";  //sets default window caption (only works with the Professional version of Studio)
...
global.menuSound = sndMenuSwitch;     //sets what sound to use for navigating the main menu
global.menuSoundSelect = sndOk00;
global.menuSaveSelect = sndChark;
global.menuCancel = sndCancel00;
...
global.secretItemTotal = 1;     //sets how many secret items for the game to save/load
global.bossItemTotal = 5;       //sets how many boss items for the game to save/load
global.autosaveSecretItems = 1; //sets whether to save secret items immediately when you grab them or if you have to hit a save
