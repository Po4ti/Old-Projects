...
global.month = date_get_month(date_current_datetime());
global.day = date_get_day(date_current_datetime());

if (global.month = 12 && global.day >= 23) || (global.month = 1 && global.day = 1) {
    global.Xmas = true;
}


global.objSpotLight_surface = surface_create(800,608);
global.visitedDexter = 0;
global.visitedAlmurat = 0;
global.visitedCatBoss = 0;
global.STGlives = 5;
global.savenum = 1;
