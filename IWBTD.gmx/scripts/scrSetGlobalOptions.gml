...
global.dust = 0;
global.debugMode = 1;
global.curTime = 0;       //enables debug keys (check objWorld step to see all of them), make sure to set this to "false" before releasing your game
...
global.debugNoDeath = 0;    //enables god mode (toggle with Home key)
...
global.roomCaptionDef = "I Wanna Be The Dancer";  //sets default window caption (only works with the Professional version of Studio)
