...
ds_map_add(saveMap,"pr",global.pr);
ds_map_add(saveMap,"pb",global.pb);
for (var i = 0; i < 26; i++)
{
    ds_map_add(saveMap,"at["+string(i)+"]",global.at[i]);
}
for (var i = 0; i < 26; i++)
{
    ds_map_add(saveMap,"plx["+string(i)+"]",global.plx[i]);
}
for (var i = 0; i < 26; i++)
{
    ds_map_add(saveMap,"ply["+string(i)+"]",global.ply[i]);
}
